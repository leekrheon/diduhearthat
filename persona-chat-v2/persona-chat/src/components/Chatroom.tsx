  ...
  return (
    <div className="relative h-full overflow-hidden bg-black flex flex-col select-none">
      ...
      <div className="absolute inset-0 z-10 flex items-end justify-center">
        <div className="relative w-full max-w-sm" style={{ height: '75%', marginBottom: '220px' }}>
          {!imgError ? (
            <motion.img
              key={character.id}
      ...
      <div className="absolute bottom-0 left-0 right-0 z-20 px-4 pb-6">
        <div
          className="relative bg-white/95 backdrop-blur-xl rounded-[2rem] shadow-2xl overflow-hidden"
          onClick={handleNext}
