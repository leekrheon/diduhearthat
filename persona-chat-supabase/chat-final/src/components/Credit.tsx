...
export default function Credit({ credits, todayCount, user }: CreditProps) {
    ...
    <div className="flex flex-col h-full bg-black text-white p-6 overflow-y-auto pb-24 font-sans">
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-white/5 border border-white/10 p-6 rounded-[2rem] text-white hover:bg-white/10 transition-colors cursor-pointer">
      ...
      {/* 럭키드로우 */}
      <div className="mb-4">
        <h3 className="text-xl font-black tracking-tight mb-4 px-2">럭키드로우</h3>

        {/* 진행도 */}
        <div className="bg-white/5 border border-white/10 rounded-[2rem] p-5 mb-4">
          <div className="flex justify-between items-center mb-3">
            <span className="text-xs font-bold text-white/40 uppercase tracking-widest">오늘 대화</span>
            <span className="text-xs font-black text-white">
              {todayCount} <span className="text-white/30">/ {DAILY_GOAL}</span>
            </span>
          </div>
